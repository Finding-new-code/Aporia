            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-light-200 dark:border-dark-200 accent-blue-600 cursor-pointer"
                />
                <span className="text-sm text-black/60 dark:text-white/60">Remember me for 3 days</span>
              </label>
            </div>
