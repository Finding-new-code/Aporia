              ...
              <div className="hidden lg:flex flex-col justify-between w-[240px] border-r border-white-200 dark:border-dark-200 h-full px-3 pt-3 overflow-y-auto">
                ...
                <div className="flex flex-col space-y-1 py-[18px] px-2">
                  <button
                    ...
                    className="group flex flex-row items-center space-x-2 px-2 py-1.5 rounded-lg w-full text-sm text-black/60 dark:text-white/60 hover:bg-light-200 hover:dark:bg-dark-200 hover:text-red-500 dark:hover:text-red-400 transition duration-200 active:scale-95"
                  >
                    <LogOut size={15} />
                    <span>Log out</span>
                  </button>
                  <p className="text-xs text-black/70 dark:text-white/70 px-2 pt-1">
